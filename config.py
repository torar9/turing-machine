...
rules = [
        ...
        [Rule(q6, '0', q7, '0', Operation.L), Rule(q6, '#', q7, '#', Operation.N)],
        [Rule(q7, '0', q6, '0', Operation.L), Rule(q7, '#', q6, '0', Operation.R)],
        [Rule(q7, '1', q6, '1', Operation.L), Rule(q7, '#', q6, '#', Operation.N)],
        [Rule(q7, '2', q6, '2', Operation.L), Rule(q7, '#', q6, '#', Operation.N)],
        [Rule(q7, '3', q6, '3', Operation.L), Rule(q7, '#', q6, '#', Operation.N)],
        [Rule(q7, '#', qe, '#', Operation.N), Rule(q7, '#', qe, '#', Operation.N)],
        [Rule(q6, '1', q7, '1', Operation.L), Rule(q6, '#', q7, '#', Operation.N)],
        [Rule(q6, '2', q7, '2', Operation.L), Rule(q6, '#', q7, '#', Operation.N)],
        [Rule(q6, '3', q7, '3', Operation.L), Rule(q6, '#', q7, '#', Operation.N)],
